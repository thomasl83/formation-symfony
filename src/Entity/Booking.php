...
class Booking
{
     ...
     * @Assert\GreaterThan(propertyPath="startDate", message="La date de départ doit être ultérieure à la date d'arivée !")
     */
    private $endDate;
    ...
    /**
     * Permet de récupérer un tableau de journée qui correspondent à ma réservation
     *
